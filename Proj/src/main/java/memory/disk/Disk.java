...
public class Disk {
    ...
    private static class DiskHead {
        ...
        public void seek(int start) {
            //TODO
            int DiskSize = DISK_SIZE_B / DISK_HEAD_NUM;
            int TrackSize = DiskSize / TRACK_NUM;
            int SectorSize = TrackSize / SECTOR_PER_TRACK;
            int start0 = start % DiskSize;
            track = start0 / TrackSize;
            sector = (start0 % TrackSize) / SectorSize;
            point = start0 % SectorSize;
        }
        ...
        public void addPoint() {
            //TODO
            int start = point + sector*BYTE_PER_SECTOR + track*BYTE_PER_SECTOR*SECTOR_PER_TRACK;
            seek(start+1);
        }
    }
